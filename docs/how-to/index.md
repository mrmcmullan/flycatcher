...
- **[Custom Validators](custom-validators.md)** - Implement cross-field validation and business rules
...
<!-- 1. Check if it's explained in the [Explanations](../explanations/index.md) section -->
1. Search the [API Reference](../api/index.md) for relevant functions
2. Ask in [GitHub Discussions](https://github.com/mrmcmullan/flycatcher/discussions)
3. [Open an issue](https://github.com/mrmcmullan/flycatcher/issues) requesting a new guide
